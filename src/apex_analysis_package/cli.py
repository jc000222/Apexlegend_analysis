...
def part1():
    ...
    print("Take a look at the robot.txt file to see if it has sitemaps.From the result, 'apexlegendsstatus.com' allows scraping all webpages and provide one Sitemap.\n"
        ,xml_parse.robotstxt)
